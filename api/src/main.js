...
import mediaRouter from "./modules/media.js"; // nouveau
...
/* TMDB optionnel (ne plante pas si absent) */
(async () => {
  try {
    ...
    console.log("[API] /api/tmdb not present");
  }
})();
...
app.use((err, req, res, _next) => {
  ...
  if (process.env.NODE_ENV !== "production") {
    ...
    body.details = err.body || err.data;
  }
